...
Plugin.factoryheader = "../SoundEnginePlugin/CsoundWwiseSourceFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
{
    "CsoundWwiseSource.cpp",
    "CsoundWwiseSource.h",
    "CsoundWwiseSourceParams.cpp",
    "CsoundWwiseSourceParams.h",
}
...
{
    "CsoundWwiseSourceShared.cpp",
    "CsoundWwiseSourceFactory.h",
}
