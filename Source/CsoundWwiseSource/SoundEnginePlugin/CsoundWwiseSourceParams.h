...
#ifndef CsoundWwiseSourceParams_H
...
struct CsoundWwiseSourceParams
    : public AK::IAkPluginParam
{
    CsoundWwiseSourceParams();
    CsoundWwiseSourceParams(const CsoundWwiseSourceParams& in_rParams);
...
#endif // CsoundWwiseSourceParams_H
